...
from bin import edge_matrix

def ms1Connect(mzml_folder, ms1_folder, edge_folder, matroid_folder,
			   edge_sim_folder, top_n, mz_tol, tic_tol, lambda1, 
			   lambda2, lambda3, lambda4, alpha, beta, gamma):
	...
	with open("logFile-pairwise-edge.txt", 'w') as file1:
		for f in Path(edge_folder).glob("**/*___score.txt"):
			fileName, nRow, rowListSize, postNormVal = edge_matrix.createEdgeSimMatrix(f, 
...
mzML files.")
	...
	ms1Connect(args.mzml, args.ms1, args.edge, args.matroid, args.edgeSimMatrix,
			   args.topN, args.mzTol, args.ticTol, args.lambda1, args.lambda2,
			   args.lambda3, args.lambda4, args.alpha, args.beta, args.gamma)
